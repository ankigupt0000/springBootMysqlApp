...
public class Sale {
    ...
    public Sale(Long id, String name, double percentmarkup,double costperitem,double totalsold,double totalrevenue,double shipcharge, double shipcost, double profitperitem, double returns,double totalincome ) {
        this.id = id;
        this.name = name;
